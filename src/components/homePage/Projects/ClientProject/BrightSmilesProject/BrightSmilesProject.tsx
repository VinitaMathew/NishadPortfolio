  ...
  return (
    <div className="bright-smiles-container">
      ...
      <div className="objective">
        ...
        The primary objective is to design a clean and modern website that would
        provide them a prominent digital presence. A website that represents
        their emotion as a brand, their warmth and care that they provide to
        their patients, and also shows their experience and professionalism in
        the dental field.
      </div>
      <div className="analysis">
        ...
        <div>
          A series of user surveys and interviews were conducted and we did gain
          the following insights that would enable us to take a more informed
          decision while designing the clinic website.{" "}
        </div>
        <ul>
          <li>
          ...
          <li>
            Referral from a friend turned out to be one of the popular reason to
            choose a dentist
          </li>
          <li>
            People prefer to visit the dentist either on a weekday evening or a
            weekend morning
          </li>
          <li>
            People didn’t mind travelling more than 5kms for a good dental visit
          </li>
          <li>
      ...
      <div>
        ...
        <ul>
          ...
          <li>
            These websites didn’t speak about their emotions and didn’t maintain
            a tone
          </li>
          <li>
        ...
        <div>
          Thus, it was important for our dental website to speak out with a warm
          tone and maintain a young and dynamic approach with it’s
          patients/visitors
          <br />
          One important point to be noted here was the client wanted the website
          up and running as soon as possible. Thus, we decided to roll out this
          ...
          what they can do. This would also have a functionality of just booking
          a slot for a check-up.
          <br />
      ...
      <div>
        ...
        <ul>
          <li>
            ...
            <b>provide a first time customer</b> to have a free dental check-up.
          </li>
          <li>
          ...
          <li>
            ...
            <b>customers preferred to know the cost of services before hand.</b>{" "}
          ...
          <li>
            ...
            Hence, it was decided to have a layout for the services section that
            did not mislead the user into clicking to know more information.
          </li>
          <li>
            It was also very important to <b>provide social proof</b> - hence, a
            section for testimonials was added. Also, on the landing page, a
            small section was added to show the number of satisfied customers.
            This would trigger a <b>sense of trust</b> among the website users.
          </li>
        </ul>
      </div>
      ...
      <div>
        ...
        <br />
        <br />
        Poppins is the font used throughout this project. The primary reason for
        using Poppins is to convey a friendly yet professional feel to the end
        user. It shows the young and dynamic nature of Bright Smiles while also
        catering to accessibility factors like readability.
        <br />
      </div>
      ...
      <div>
        <div>
          This would probably be consider one of the most important sections of
          the website. From the research that was conducted, the users had
          mentioned about the importance of transparency. This was achieved by
          showing to the users the services offered along with the average cost
          of each treatment. Average operation time is also mentioned in order
          to provide clarity about the amount of time each of the treatment
          would take.
        </div>
        <br />
      ...
      <br />
      <div>
        Testimonials are an essential component of any dental clinic website as
        they provide valuable feedback from patients who have experienced the
        clinic's services. Positive testimonials from satisfied patients can
        help build trust and credibility for the clinic, giving potential
      ...
      <div>
        ...
        creating a sense of familiarity and confidence in their choice of dental
        provider
      </div>
      <br />
      <br />
      ...
      <div>
        ...
        clinic. This would open the location to the clinic and the customer can
        simply find directions to the place. Also, as an additional customer
        conversion element, we’ve added a button to schedule appointment or
        simply call them to book an appointment.
      </div>
      <br />
      <br />
      <h2>Conclusion</h2>
      ...
      <br />
      <div>
        Bright Smiles Orthodontics was a fun project to work on. This design of
        this project was completed within 2 weeks of commencement. This included
        the user research and interviews as well. The next phase of the project
        is yet to kick-off. Hoping it would start soon and the updates would be
        added to this case study.
        <br />
        <br /> Reach out to me for any queries regarding this project or have a
        similar idea to execute. Would love to be a part of something fun :)
      </div>
      <br />
      <br />
